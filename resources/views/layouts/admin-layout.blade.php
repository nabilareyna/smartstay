...
<head>
    ...
    <title>Dashboard Admin - SmartStay</title>
...
<body>
    ...
    <aside id="sidebar" class="sidebar">
        ...
        <ul class="sidebar-nav" id="sidebar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="/admin/room" wire:navigate>
                    <i class="bi bi-archive-fill"></i>
                    <span>Input Room</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link collapsed" href="/admin/employee" wire:navigate>
                    <i class="bi bi-archive-fill"></i>
                    <span>Input Employee</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link collapsed" href="/admin/reservation" wire:navigate>
                    <i class="bi bi-archive-fill"></i>
                    <span>Reservation & Transaction</span>
                </a>
            </li>
        </ul>
